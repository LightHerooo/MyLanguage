...
} from "../../../classes/html/select/entity/lang/workout/collection_workout/select_with_rule_element_langs_out_workout_collection_workout.js";

import {
    FormElementWorkoutCollectionWorkout
} from "../../../classes/html/form/entity/workout/form_element_workout_collection_workout.js";
...
let _selectWithRuleElementCustomerCollectionsWorkoutCollectionWorkout;
let _selectWithRuleElementLangsOutWorkoutCollectionWorkout;

let _formElementWorkoutCollectionWorkout;
//---
...
window.onload = async function() {
    ...
    await prepareFormElementWorkoutCollectionWorkout();
    //---
    ...
    if (_formElementWorkoutCollectionWorkout) {
        _formElementWorkoutCollectionWorkout.setTableWithTimerElementWorkoutsNotOver(_tableWithTimerElementWorkoutsNotOver);
        _formElementWorkoutCollectionWorkout.changeDisabledStatusToFormElements(false);
    }

    if (_tableWithTimerElementWorkoutsNotOver) {
        _tableWithTimerElementWorkoutsNotOver.setFormElementCreateNewWorkout(_formElementWorkoutCollectionWorkout);
...
async function prepareCoupleSelectElementsForWorkoutCollectionWorkout() {
    ...
    if (divContainer && select && spanFlag) {
        ...
        _selectWithRuleElementCustomerCollectionsWorkoutCollectionWorkout.prepare();
    }
    //---
    ...
    if (divContainer && select && spanFlag) {
        ...
        _selectWithRuleElementLangsOutWorkoutCollectionWorkout.prepare();
    }
    //---

    // Связывваем два списка между собой ---
    _selectWithRuleElementCustomerCollectionsWorkoutCollectionWorkout
        .setSelectWithRuleElementLangsOutWorkoutCollectionWorkout(_selectWithRuleElementLangsOutWorkoutCollectionWorkout);
    _selectWithRuleElementLangsOutWorkoutCollectionWorkout
        .setSelectWithRuleElementCustomerCollectionsWorkoutCollectionWorkout(_selectWithRuleElementCustomerCollectionsWorkoutCollectionWorkout)
    //---

    // Заполняем списки ---
    await _selectWithRuleElementCustomerCollectionsWorkoutCollectionWorkout.fill();
    await _selectWithRuleElementLangsOutWorkoutCollectionWorkout.fill();
    //---
}

async function prepareFormElementWorkoutCollectionWorkout() {
    let form = document.getElementById("form_workout_collection_workout");
    let buttonSubmit = document.getElementById("button_submit_workout_collection_workout");
    let buttonReset = document.getElementById("button_reset_workout_collection_workout");
    let divMessageContainer = document.getElementById("div_message_container_workout_collection_workout");
    if (form && buttonSubmit && buttonReset && divMessageContainer) {
        _formElementWorkoutCollectionWorkout = new FormElementWorkoutCollectionWorkout(
            form, buttonSubmit, divMessageContainer);
        _formElementWorkoutCollectionWorkout.setButtonReset(buttonReset);
        _formElementWorkoutCollectionWorkout.setSelectWithRuleElementCustomerCollectionsWorkoutCollectionWorkout(
            _selectWithRuleElementCustomerCollectionsWorkoutCollectionWorkout);
        _formElementWorkoutCollectionWorkout.setSelectWithRuleElementLangsOutWorkoutCollectionWorkout(
            _selectWithRuleElementLangsOutWorkoutCollectionWorkout);

        await _formElementWorkoutCollectionWorkout.prepare();
    }
}
//---
