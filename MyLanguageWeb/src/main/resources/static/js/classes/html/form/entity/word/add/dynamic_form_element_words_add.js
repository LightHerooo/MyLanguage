...
import {
    DynamicFormRowElementWordAdd
} from "./dynamic_form_row_element_word_add.js";
...
export class DynamicFormElementWordsAdd extends DynamicFormAbstractElement {
    ...
    createDynamicFormRowElementObject() {
        let dynamicFormRowElementWordAdd = new DynamicFormRowElementWordAdd(null);

        let dynamicFormRowDataElement = dynamicFormRowElementWordAdd.getDynamicFormRowDataElement();
        ...
        return dynamicFormRowElementWordAdd;
    }
