...
import {
    DynamicFormRowElementCustomerCollectionAdd
} from "./dynamic_form_row_element_customer_collection_add.js";
...
export class DynamicFormElementCustomerCollectionsAdd extends DynamicFormAbstractElement {
    ...
    createDynamicFormRowElementObject() {
        let dynamicFormRowElementCustomerCollectionAdd =
            new DynamicFormRowElementCustomerCollectionAdd(null);

        let dynamicFormRowDataElement = dynamicFormRowElementCustomerCollectionAdd.getDynamicFormRowDataElement();
        ...
        return dynamicFormRowElementCustomerCollectionAdd;
    }
